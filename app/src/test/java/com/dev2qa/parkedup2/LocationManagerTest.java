...
//    }
    ...
    @Test
    public void timeToCar() {
        obj.toggleUnits(); //to km
        obj.setSpeed(5.0);
        obj.setDistance(.86);
        assertEquals("2 mins, 52 secs",obj.timeToCar());
        obj.setSpeed(0.0);
        obj.setDistance(5.0);
        assertEquals("13 hrs, 16 mins, 43 secs",obj.timeToCar());
        obj.setDistance(4.0);
        assertEquals("5 hrs, 49 mins, 22 secs",obj.timeToCar());
        //Week 2 Tests
